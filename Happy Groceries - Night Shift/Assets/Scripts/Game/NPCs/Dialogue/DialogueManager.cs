...
public class DialogueManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Initialize specific dialogue sequence as requested
        InitializeDialogue();
    }
    ...
    void InitializeDialogue()
    {
        ...
        // true = auto advance, false = wait for input
        dialogueData.autoProgressLines = new bool[] { true, false };
        
        // Ensure valid default values
        if (dialogueData.autoProgressDelay <= 0) dialogueData.autoProgressDelay = 2.0f;
        if (dialogueData.TypingSpeed <= 0) dialogueData.TypingSpeed = 0.05f;
    }
